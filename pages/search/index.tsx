      ...
      <section className={styles.doctorsSection}>
        <div className={styles.gridContainer}>
          ...
          <div className={styles.info}>
            <div className={`${styles.speciality} ${adelleSansFont.className}`}>
              HAIR TRANSPLANT
            </div>
          ...
          <div className={`${styles.reviews} ${adelleSansFont.className}`}>
            ...
            <div className={styles.item}>
              ...
              <div>
                <span className={styles.text}>1270 treatments last year</span>
              </div>
            </div>
            <div className={styles.item}>
              <div>
          ...
          <div className={`${styles.startingFrom} ${adelleSansFont.className}`}>
            <p className={styles.text}>starting from</p>
            <p className={styles.price}>€2,090</p>
          </div>
          <div className={styles.CTAButton}>
            <button className={nettoFont.className}>See doctor profile</button>
          </div>
        </div>
      </section>
      <Divider />
